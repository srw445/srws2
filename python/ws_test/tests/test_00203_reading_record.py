...
evidence_no = 1
# テストコード名
script_name = os.path.splitext(os.path.basename(__file__))[0]  # 例: test_00203_reading_record
# コメント
comment = ''
...
def test_code():
    ...
    try:
        ...
        # 更新データ確認
        sql_path = os.path.join(os.path.dirname(__file__), '../sqls/test_00203_reading_record_01.sql')
